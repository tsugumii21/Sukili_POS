...
extension CategoryCollectionByIndex on IsarCollection<CategoryCollection> {
  Future<CategoryCollection?> getBySyncId(String syncId) {
    return getByIndex(r'syncId', [syncId]);
  }

  CategoryCollection? getBySyncIdSync(String syncId) {
  ...
  Future<List<CategoryCollection?>> getAllBySyncId(List<String> syncIdValues) {
    final values = syncIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'syncId', values);
  }

  List<CategoryCollection?> getAllBySyncIdSync(List<String> syncIdValues) {
    final values = syncIdValues.map((e) => [e]).toList();
  ...
  Future<Id> putBySyncId(CategoryCollection object) {
    return putByIndex(r'syncId', object);
  }

  Id putBySyncIdSync(CategoryCollection object, {bool saveLinks = true}) {
    return putByIndexSync(r'syncId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllBySyncId(List<CategoryCollection> objects) {
    return putAllByIndex(r'syncId', objects);
  }

  List<Id> putAllBySyncIdSync(List<CategoryCollection> objects,
      {bool saveLinks = true}) {
...
extension CategoryCollectionQueryWhereSort
  ...
  QueryBuilder<CategoryCollection, CategoryCollection, QAfterWhere>
      anySortOrder() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryCollectionQueryProperty
  ...
  QueryBuilder<CategoryCollection, DateTime, QQueryOperations>
      createdAtProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CategoryCollection, bool, QQueryOperations> isActiveProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isActive');
    });
  }

  QueryBuilder<CategoryCollection, bool, QQueryOperations> isDeletedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isDeleted');
    });
  }

  QueryBuilder<CategoryCollection, bool, QQueryOperations> isSyncedProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CategoryCollection, int, QQueryOperations> sortOrderProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'sortOrder');
    });
  }

  QueryBuilder<CategoryCollection, String, QQueryOperations> syncIdProperty() {
    return QueryBuilder.apply(this, (query) {
