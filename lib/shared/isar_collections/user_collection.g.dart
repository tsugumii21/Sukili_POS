...
extension UserCollectionByIndex on IsarCollection<UserCollection> {
  Future<UserCollection?> getBySyncId(String syncId) {
    return getByIndex(r'syncId', [syncId]);
  }

  UserCollection? getBySyncIdSync(String syncId) {
  ...
  Future<List<UserCollection?>> getAllBySyncId(List<String> syncIdValues) {
    final values = syncIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'syncId', values);
  }

  List<UserCollection?> getAllBySyncIdSync(List<String> syncIdValues) {
    final values = syncIdValues.map((e) => [e]).toList();
  ...
  Future<Id> putBySyncId(UserCollection object) {
    return putByIndex(r'syncId', object);
  }

  Id putBySyncIdSync(UserCollection object, {bool saveLinks = true}) {
    return putByIndexSync(r'syncId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllBySyncId(List<UserCollection> objects) {
    return putAllByIndex(r'syncId', objects);
  }

  List<Id> putAllBySyncIdSync(List<UserCollection> objects,
      {bool saveLinks = true}) {
...
extension UserCollectionQueryWhere
  ...
  QueryBuilder<UserCollection, UserCollection, QAfterWhereClause> syncIdEqualTo(
      String syncId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserCollection, UserCollection, QAfterWhereClause> roleEqualTo(
      String role) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'role',
  ...
  QueryBuilder<UserCollection, UserCollection, QAfterWhereClause> statusEqualTo(
      String status) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'status',
...
extension UserCollectionQuerySortBy
  ...
  QueryBuilder<UserCollection, UserCollection, QAfterSortBy> sortByIsSynced() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserCollection, UserCollection, QAfterSortBy> sortByPinHash() {
    return QueryBuilder.apply(this, (query) {
...
extension UserCollectionQuerySortThenBy
  ...
  QueryBuilder<UserCollection, UserCollection, QAfterSortBy> thenByIsSynced() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isSynced', Sort.asc);
    });
  }
  ...
  QueryBuilder<UserCollection, UserCollection, QAfterSortBy> thenByPinHash() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'pinHash', Sort.asc);
    });
  }
...
extension UserCollectionQueryWhereDistinct
  ...
  QueryBuilder<UserCollection, UserCollection, QDistinct> distinctByIsSynced() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserCollection, UserCollection, QDistinct> distinctByPinHash(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension UserCollectionQueryProperty
  ...
  QueryBuilder<UserCollection, bool, QQueryOperations> isSyncedProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserCollection, String?, QQueryOperations> pinHashProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserCollection, String, QQueryOperations> syncIdProperty() {
    return QueryBuilder.apply(this, (query) {
