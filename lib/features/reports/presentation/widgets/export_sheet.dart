...
class ExportSheet extends StatelessWidget {
          ...
          if (orders.isNotEmpty)
            pw.TableHelper.fromTextArray(
              ...
              headerDecoration: pw.BoxDecoration(
                  color: PdfColor.fromHex('#6B2C33')),
              oddRowDecoration: pw.BoxDecoration(
                  color: PdfColor.fromHex('#FAF6F1')),
            )
          else
  ...
  Future<void> _exportExcel(BuildContext context) async {
    ...
    summary.appendRow(
        [xl.TextCellValue('Metric'), xl.TextCellValue('Value')]);
    summary.appendRow([
    ...
    summary.appendRow([xl.TextCellValue('')]);
    summary
        .appendRow([xl.TextCellValue('Payment Breakdown')]);
    summary.appendRow([
    ...
    final cashierEntries = cashierMap.entries.toList()
      ..sort((a, b) {
        final ra = (a.value as List).fold<double>(
            0, (s, o) => s + (o.totalAmount as double));
        final rb = (b.value as List).fold<double>(
            0, (s, o) => s + (o.totalAmount as double));
